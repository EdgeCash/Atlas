...
Status: **steps 0-2 done** (see §7). Scope v1: DraftKings NFL Classic,
...
| 3 | Projection model v1, team-anchored | beats the baseline's CRPS at every position among the regulars, and ranks each position's regulars at least as well as salary does (the step 2 finding makes both bars real) |

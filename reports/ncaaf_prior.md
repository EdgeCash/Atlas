...
### net  -  game-level R² 0.304, residual sd 17.40 points, home advantage +2.52, n=4882 games
...
| fpi | +3.41 |
| talent | +2.26 |
| returning_production | +1.68 |
| recruiting_rank | -1.38 |

### off  -  from one stacked points regression, R² 0.214, residual sd 12.24 points per team-game, n=9764 team-games
...
| fpi | +1.95 |
| sp_plus_off | +1.81 |
| returning_production | +1.02 |
| recruiting_rank | -0.16 |

### def  -  from one stacked points regression, R² 0.214, residual sd 12.24 points per team-game, n=9764 team-games

| feature | points_per_sd |
|---|---|
| fpi | +2.30 |
| sp_plus_def | -2.27 |
| recruiting_rank | -1.28 |
| returning_production | +0.63 |
| talent | +0.25 |

A team's prior net has sd 10.15 points across the 136 FBS teams of 2025; the game residual sd of 17.40 is the prior's own uncertainty and the state model's starting variance.

## How well the prior tracked the eventual rating, team level

| season | corr def | corr net | corr off |
|---|---|---|---|
| 2021.000 | 0.680 | 0.705 | 0.569 |
| 2022.000 | 0.715 | 0.782 | 0.697 |
| 2023.000 | 0.729 | 0.803 | 0.658 |
| 2024.000 | 0.690 | 0.717 | 0.628 |
| 2025.000 | 0.690 | 0.751 | 0.653 |
...
| prior | 1020 | 9.509 | 0.175 | 4.125 | 13.47 | 0.017 |
...
| prior | 2021 | 205 | 9.711 | 0.178 | 4.176 | 13.81 | 0.046 |
| prior | 2022 | 210 | 9.409 | 0.180 | 4.075 | 13.59 | 0.037 |
| prior | 2023 | 216 | 8.433 | 0.165 | 3.972 | 12.07 | 0.046 |
| prior | 2024 | 194 | 10.442 | 0.179 | 4.254 | 14.84 | 0.084 |
| prior | 2025 | 195 | 9.667 | 0.175 | 4.166 | 13.18 | 0.061 |

## The 2025 prior, top and bottom ten by net

| team | net | off | def |
|---|---|---|---|
| Ohio State | +22.8 | +10.5 | +12.5 |
| Alabama | +20.3 | +10.0 | +10.3 |
| Texas | +19.7 | +9.3 | +11.6 |
| Georgia | +19.5 | +9.5 | +9.8 |
| Penn State | +19.3 | +9.3 | +10.3 |
| Notre Dame | +19.0 | +9.4 | +10.4 |
| Oregon | +17.9 | +8.9 | +8.7 |
| Ole Miss | +16.8 | +6.8 | +9.6 |
| Tennessee | +15.5 | +6.4 | +9.2 |
| LSU | +15.2 | +8.4 | +6.7 |
| Middle Tennessee | -16.2 | -7.6 | -8.0 |
| Temple | -16.2 | -7.3 | -9.1 |
| New Mexico State | -16.9 | -8.1 | -9.5 |
| Tulsa | -17.1 | -6.7 | -10.4 |
| Ball State | -17.9 | -7.6 | -10.4 |
| Massachusetts | -18.4 | -7.3 | -10.7 |
| New Mexico | -18.4 | -6.6 | -11.6 |
| Southern Miss | -18.7 | -8.3 | -10.0 |
| Kennesaw State | -21.5 | -11.2 | -10.0 |
| Kent State | -25.3 | -12.0 | -13.0 |

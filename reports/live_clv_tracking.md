...
*Generated 2026-09-23 22:10 UTC by `python -m atlas.live report`. Updated on every run
...
|---|---|---|
| `tracking/games.csv` | 71 | every game seen, with kickoff and status |
| `tracking/snapshots.csv` | 340 | append-on-change line observations, timestamped |

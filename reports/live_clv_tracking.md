...
*Generated 2026-09-22 17:45 UTC by `python -m atlas.live report`. Updated on every run
...
|---|---|---|
| `tracking/games.csv` | 58 | every game seen, with kickoff and status |
| `tracking/snapshots.csv` | 118 | append-on-change line observations, timestamped |

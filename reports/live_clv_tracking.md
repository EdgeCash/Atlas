...
*Generated 2026-09-26 16:07 UTC by `python -m atlas.live report`. Updated on every run
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| observed | 30 | 22 | 8 | 0.4091 | 0.2326 | 0.6127 | 0.8569 | 0.0000 | 0 | 0.0003 | 12 |
| all | 30 | 22 | 8 | 0.4091 | 0.2326 | 0.6127 | 0.8569 | 0.0000 | 0 | 0.0003 | 12 |
...
| `tracking/snapshots.csv` | 929 | append-on-change line observations, timestamped |
| `tracking/signals.csv` | 143 | immutable opinions |
| `tracking/grades.csv` | 30 | one row per graded signal |

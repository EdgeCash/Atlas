...
*Generated 2026-09-26 19:07 UTC by `python -m atlas.live report`. Updated on every run
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| observed | 40 | 29 | 11 | 0.3448 | 0.1994 | 0.5266 | 0.9693 | -0.1375 | 0 | -0.0021 | 17 |
| all | 40 | 29 | 11 | 0.3448 | 0.1994 | 0.5266 | 0.9693 | -0.1375 | 0 | -0.0021 | 17 |
...
| `tracking/snapshots.csv` | 1,001 | append-on-change line observations, timestamped |
| `tracking/signals.csv` | 143 | immutable opinions |
| `tracking/grades.csv` | 40 | one row per graded signal |

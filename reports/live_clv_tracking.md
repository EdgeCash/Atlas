...
*Generated 2026-09-26 17:37 UTC by `python -m atlas.live report`. Updated on every run
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| observed | 34 | 25 | 9 | 0.3600 | 0.2025 | 0.5548 | 0.9461 | -0.0735 | 0 | -0.0016 | 14 |
| all | 34 | 25 | 9 | 0.3600 | 0.2025 | 0.5548 | 0.9461 | -0.0735 | 0 | -0.0016 | 14 |
...
| `tracking/snapshots.csv` | 969 | append-on-change line observations, timestamped |
| `tracking/signals.csv` | 143 | immutable opinions |
| `tracking/grades.csv` | 34 | one row per graded signal |

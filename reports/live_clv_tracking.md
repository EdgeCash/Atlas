...
*Generated 2026-09-24 21:46 UTC by `python -m atlas.live report`. Updated on every run
...
|---|---|---|
| `tracking/games.csv` | 88 | every game seen, with kickoff and status |
| `tracking/snapshots.csv` | 621 | append-on-change line observations, timestamped |
| `tracking/signals.csv` | 232 | immutable opinions |
| `tracking/grades.csv` | 0 | one row per graded signal |

...
*Generated 2026-09-25 21:13 UTC by `python -m atlas.live report`. Updated on every run
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| observed | 4 | 2 | 2 | 0.0000 | 0.0000 | 0.6576 | 1.0000 | -0.3750 | -0.25 | -0.0050 | 0 |
| all | 4 | 2 | 2 | 0.0000 | 0.0000 | 0.6576 | 1.0000 | -0.3750 | -0.25 | -0.0050 | 0 |
...
| `tracking/snapshots.csv` | 683 | append-on-change line observations, timestamped |
| `tracking/signals.csv` | 120 | immutable opinions |
| `tracking/grades.csv` | 4 | one row per graded signal |

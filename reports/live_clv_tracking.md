...
*Generated 2026-09-26 18:22 UTC by `python -m atlas.live report`. Updated on every run
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| observed | 38 | 27 | 11 | 0.3333 | 0.1864 | 0.5218 | 0.9739 | -0.1316 | 0 | -0.0026 | 16 |
| all | 38 | 27 | 11 | 0.3333 | 0.1864 | 0.5218 | 0.9739 | -0.1316 | 0 | -0.0026 | 16 |
...
| `tracking/snapshots.csv` | 987 | append-on-change line observations, timestamped |
| `tracking/signals.csv` | 143 | immutable opinions |
| `tracking/grades.csv` | 38 | one row per graded signal |

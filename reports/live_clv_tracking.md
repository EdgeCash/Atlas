...
*Generated 2026-09-24 22:45 UTC by `python -m atlas.live report`. Updated on every run
...
| `tracking/snapshots.csv` | 356 | append-on-change line observations, timestamped |
| `tracking/signals.csv` | 116 | immutable opinions |

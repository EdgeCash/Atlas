...
*Generated 2026-09-26 19:07 UTC by `python -m atlas.live check`. Atlas research is
...
| Grades recorded | 40 |
| Line snapshots | 1,001 |
| Tracker runs logged | 67 |
...
| card_grades | 83 | 17 | sport, game_id |
| other_models | 358 | 9 | sport, game_id, model |
...
| availability | 262 | 13 | conference, report_id, team, player |
| games | 102 | 14 | game_id |
| snapshots | 1,001 | 11 | game_id, book, market, captured_at |
| signals | 143 | 17 | signal_id |
| grades | 40 | 14 | signal_id |

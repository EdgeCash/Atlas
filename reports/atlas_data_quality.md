...
*Generated 2026-09-26 19:07 UTC by `python -m atlas.live check`. Regenerated on every
...
| grade references a signal | blocking | grades | 40 | 0 | yes |
| clv is consistent | blocking | grades | 40 | 0 | yes |
| result matches clv | blocking | grades | 40 | 0 | yes |
| one grade per signal | blocking | grades | 40 | 0 | yes |
| probabilities in range | blocking | grades | 40 | 0 | yes |
| clv_prob is consistent | blocking | grades | 40 | 0 | yes |
